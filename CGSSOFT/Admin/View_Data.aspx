...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <div class="text-center">
                            ...
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" CssClass="table table-bordered table-hover table-responsive" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" AllowPaging="True" style="margin-bottom: 0px" ShowFooter="True" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="View Files">
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Eval("Files") %>' ></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Download File">
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink2" runat="server" Text='<%# Eval("DFILE") %>' ></asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <div class="text-center">
            ...
            <asp:Button ID="Button1" runat="server" Text="Print" OnClick="Button1_Click" style="height: 29px" />
        </div>
        <br>
        <br>
    </div>
